...
browser.get("https://www.google.co.kr/imghp?hl=ko&tab=wi&ei=5VQdWbOvMI308AXZtrToAw&ved=0EKouCBUoAQ")
...
def fetch_list_url():
    ...
    for im in imgList:
        try:
            params.append(im["data-src"]) # params 리스트 변수에 image url 을 append 한다.
        except KeyError:
            pass
    return params
...
def fetch_detail_url():
    ...
    for i in params:
        #print(i)
        # 다운받을 폴더경로 입력
        urllib.request.urlretrieve(i, "d:/googleImages/" + str(a) + ".jpg")
        a = a + 1
